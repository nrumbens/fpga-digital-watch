`timescale 1ns / 1ps
// Top level stopwatch module with start/stop, freeze/live and reset behaviour.
// Displays the centiseconds, seconds and minutes and allows frozen display while
// counter continues
